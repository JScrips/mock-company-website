...
const Sidebar = () => {
    ...
    <div className="flex flex-col w-full h-full px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
    <div className='flex items-center gap-2'>
        <h2 className=" text-3xl font-semibold text-gray-800 dark:text-white">Yep, Brand </h2>
        <FaEarlybirds className='text-5xl text-white' />
    </div>
