...
const MainContent = () => {
    return (
        <div className=' w-full  h-[104rem]'>

<section className="text-gray-400 body-font bg-gray-900 h-[105rem]">
  <div className="container px-5 py-24 mx-auto ">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-white">Random Main Content</h1>
    ...
    <div className="flex flex-wrap -m-4 h-[62rem]">
